    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:8000/api/v1/users/changePassword' : 'http://127.0.0.1:8000/api/v1/users/updateMyProfile';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
console.log('Bundle.js'); //DOM ELEMENTS

var mapBox = document.getElementById('map');
var loginForm = document.querySelector('#loginForm');
var logoutBtn = document.querySelector('#logout');
var updateDataForm = document.querySelector('#updateDataForm');
var updatePwdForm = document.querySelector('#updatePwdForm'); //DELEGATION
...
if (updatePwdForm) {
  updatePwdForm.addEventListener('submit', /*#__PURE__*/function () {
